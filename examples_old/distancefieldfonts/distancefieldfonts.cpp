...
public:
	...
	void setupVertexDescriptions()
	{
		...
		verticies.inputState.vertexBindingDescriptionCount = verticies.bindingDescriptions.size();
		verticies.inputState.pVertexBindingDescriptions = verticies.bindingDescriptions.data();
		verticies.inputState.vertexAttributeDescriptionCount = verticies.attributeDescriptions.size();
