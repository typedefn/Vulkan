...
//	*/
  void createDescriptorSets() {
    ...
    VkDescriptorImageInfo textureImageDescriptor { VK_NULL_HANDLE,
        image.view, VK_IMAGE_LAYOUT_GENERAL };
    ...
    // Binding 0: Top level acceleration structure
        ...
        // Binding 5: Textures
        vks::initializers::writeDescriptorSet(descriptorSet,
            VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, 1, &textureImageDescriptor),
