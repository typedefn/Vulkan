...
#define FRACTAL
	...
	{
		// Binding description
		verticies.inputBinding.resize(1);
		verticies.inputBinding[0] =
		...
		verticies.inputAttributes.resize(3);
		// Location 0 : Position
		verticies.inputAttributes[0] =
		...
		verticies.inputState.vertexBindingDescriptionCount = static_cast<uint32_t>(verticies.inputBinding.size());
		verticies.inputState.pVertexBindingDescriptions = verticies.inputBinding.data();
		verticies.inputState.vertexAttributeDescriptionCount = static_cast<uint32_t>(verticies.inputAttributes.size());
		verticies.inputState.pVertexAttributeDescriptions = verticies.inputAttributes.data();
	}
