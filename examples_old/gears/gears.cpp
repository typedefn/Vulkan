...
public:
	...
	void prepareVertices()
	{
		...
		verticies.bindingDescriptions.resize(1);
		verticies.bindingDescriptions[0] =
		...
		verticies.attributeDescriptions.resize(3);
		// Location 0 : Position
		verticies.attributeDescriptions[0] =
			vks::initializers::vertexInputAttributeDescription(
				...
				0);
		// Location 1 : Normal
		verticies.attributeDescriptions[1] =
			vks::initializers::vertexInputAttributeDescription(
				VERTEX_BUFFER_BIND_ID,
				1,
				VK_FORMAT_R32G32B32_SFLOAT,
				sizeof(float) * 3);
		// Location 2 : Color
		verticies.attributeDescriptions[2] =
			vks::initializers::vertexInputAttributeDescription(
				VERTEX_BUFFER_BIND_ID,
				2,
				VK_FORMAT_R32G32B32_SFLOAT,
		...
		verticies.inputState = vks::initializers::pipelineVertexInputStateCreateInfo();
		verticies.inputState.vertexBindingDescriptionCount = static_cast<uint32_t>(verticies.bindingDescriptions.size());
		verticies.inputState.pVertexBindingDescriptions = verticies.bindingDescriptions.data();
		verticies.inputState.vertexAttributeDescriptionCount = static_cast<uint32_t>(verticies.attributeDescriptions.size());
		verticies.inputState.pVertexAttributeDescriptions = verticies.attributeDescriptions.data();
	}
	...
	void preparePipelines()
	{
		...
		pipelineCreateInfo.pVertexInputState = &verticies.inputState;
